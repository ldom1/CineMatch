export default function Footer() {
  return (
    <footer className="rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:flex sm:items-center sm:justify-between sm:p-6 xl:p-8">
      <p className="mb-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2019-2022
        <a
          href="https://epidemie-des-motsv2.vercel.app/"
      ...
      <div className="flex items-center justify-center space-x-1">
        <a
          href="https://www.linkedin.com/in/louis-giron-86b677ab/"
        ...
        <a
          href="https://twitter.com/giron_dom"
